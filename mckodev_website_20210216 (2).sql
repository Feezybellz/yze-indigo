...
--
-- Host: localhost:3306
-- Generation Time: Jun 26, 2022 at 11:37 PM
...
--
-- Table structure for table `addition_amenities_and_facilities`
--

CREATE TABLE `addition_amenities_and_facilities` (
  ...
  `icon_icon` text NOT NULL,
  `date_created` date NOT NULL,
  `time_created` time NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `addition_amenities_and_facilities`
--

INSERT INTO `addition_amenities_and_facilities` (`id`, `input_title`, `tb`, `tb_link`, `hash_id`, `visibility`, `icon_icon`, `date_created`, `time_created`) VALUES
(13, 'New Fac', 'Demo Project 1', 'hash03jd', '1656286386_68768', 'hide', '<p>New Fac</p>', '2022-06-26', '23:33:06'),
(14, 'Testing 2', 'Demo Project 1', 'hash03jd', '1656286488_26237', 'hide', 'fas fa-ambulance', '2022-06-26', '23:34:48');
...
(292, 'Fawaz', 'Adelaja', 'adelajaarc148304@futa.edu.ng', '$2y$10$DRk8Ijuu1ucBBzv0ds7xw.h9vS87VmOrBS0g3BtVgznseKKqbMQxS', '163836550042f13847z2a4a1w', '555666777888999000', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '13:31:40', '2021-12-01', NULL, NULL, NULL, 'MASTER', '1', NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(293, 'afeez', 'bello', 'bellzfeezy9@gmail.com', '$2y$10$xA9MReZjpBMGrqjzTe8R0ugijJ5UBw2h5tKYWu7TJU9NVEMCR9l6a', '1633850293z53320ee045af68', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '07:18:13', '2021-10-10', NULL, NULL, NULL, '3', '1', NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(53, '657767', 'j90819542aBn72i', '163836550042f13847z2a4a1w', '2021-12-01', '13:09:07');
...
CREATE TABLE `panel_projects` (
  ...
  `text_body` text,
  `add_amenities_and_facilities` char(100) DEFAULT NULL,
  `image_2` text,
  `visibility` char(4) NOT NULL,
  `date_created` date NOT NULL,
  `time_created` time NOT NULL
...
--
-- Indexes for table `addition_amenities_and_facilities`
--
ALTER TABLE `addition_amenities_and_facilities`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `addition_amenities_and_facilities`
--
ALTER TABLE `addition_amenities_and_facilities`
