...
include 'includes/header.php';
 ?>
  <div class="side-content">
    <figure> <img src="asset/images/logo-light.png" alt="Image"> </figure>
...
<nav class="navbar">
  <div class="container">
    <div class="upper-side">
      <div class="logo"> <a href="index.html"><img src="asset/images/logo-light.png" alt="Image"></a> </div>
      <!-- end logo -->
      <div class="phone-email"> <img src="asset/images/icon-phone.png" alt="Image">
  ...
  <div class="container">
    <div class="row">
      <div class="col-12">
        ...
        <!-- end property-infos -->
        <img src="asset/images/plan01.jpg" alt="Image" class="property-plan">
      </div>
      <!-- end col-12 -->
      <div class="col-lg-7">
      ...
      <!-- end col-5 -->
      <div class="col-md-4">
        <figure><img src="asset/images/blog01.jpg" alt="Image"></figure>
      </div>
      <!-- end col-4 -->
      <div class="col-md-4">
        <figure><img src="asset/images/blog02.jpg" alt="Image"></figure>
      </div>
      <!-- end col-4 -->
      <div class="col-md-4">
        <figure><img src="asset/images/blog03.jpg" alt="Image"></figure>
      </div>
      <!-- end col-4 -->
      <div class="col-12">
    ...
    <div class="swiper-wrapper">
      <div class="swiper-slide"><img src="asset/images/blog01.jpg" alt="Image"></div>
      <div class="swiper-slide"><img src="asset/images/blog02.jpg" alt="Image"></div>
      <div class="swiper-slide"><img src="asset/images/blog03.jpg" alt="Image"></div>
      <div class="swiper-slide"><img src="asset/images/blog04.jpg" alt="Image"></div>
    </div>
    <!-- add swiper-wrapper -->
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-2 col-md-4 col-sm-6 col-6 wow fadeInUp" data-wow-delay="0.20s">
        <figure data-toggle="tooltip" data-placement="top" title="The smaller male cones release pollen, which fertilizes"> <img src="/asset/images/services-icon05.png" alt="Image">
          <figcaption>Ceramics</figcaption>
        </figure>
      </div>
      <!-- end col-2 -->
      <div class="col-lg-2 col-md-4 col-sm-6 col-6 wow fadeInUp" data-wow-delay="0.25s">
        <figure data-toggle="tooltip" data-placement="top" title="The smaller male cones release pollen, which fertilizes"> <img src="/asset/images/services-icon06.png" alt="Image">
          <figcaption>Pipelines</figcaption>
        </figure>
      </div>
      <!-- end col-2 -->
      <div class="col-lg-2 col-md-4 col-sm-6 col-6 wow fadeInUp" data-wow-delay="0s">
        <figure data-toggle="tooltip" data-placement="top" title="The smaller male cones release pollen, which fertilizes"> <img src="/asset/images/services-icon07.png" alt="Image">
          <figcaption>Cimento</figcaption>
        </figure>
      </div>
      <!-- end col-2 -->
      <div class="col-lg-2 col-md-4 col-sm-6 col-6 wow fadeInUp" data-wow-delay="0.05s">
        <figure data-toggle="tooltip" data-placement="top" title="The smaller male cones release pollen, which fertilizes"> <img src="/asset/images/services-icon08.png" alt="Image">
          <figcaption>Hummer</figcaption>
        </figure>
      </div>
      <!-- end col-2 -->
      <div class="col-lg-2 col-md-4 col-sm-6 col-6 wow fadeInUp" data-wow-delay="0.10s">
        <figure data-toggle="tooltip" data-placement="top" title="The smaller male cones release pollen, which fertilizes"> <img src="/asset/images/services-icon09.png" alt="Image">
          <figcaption>Digging</figcaption>
        </figure>
      </div>
      <!-- end col-2 -->
      <div class="col-lg-2 col-md-4 col-sm-6 col-6 wow fadeInUp" data-wow-delay="0.15s">
        <figure data-toggle="tooltip" data-placement="top" title="The smaller male cones release pollen, which fertilizes"> <img src="/asset/images/services-icon10.png" alt="Image">
          <figcaption>Raiser</figcaption>
        </figure>
      </div>
      <!-- end col-2 -->
      <div class="col-lg-2 col-md-4 col-sm-6 col-6 wow fadeInUp" data-wow-delay="0.20s">
        <figure data-toggle="tooltip" data-placement="top" title="The smaller male cones release pollen, which fertilizes"> <img src="/asset/images/services-icon11.png" alt="Image">
          <figcaption>Screwsrive</figcaption>
        </figure>
      </div>
      <!-- end col-2 -->
      <div class="col-lg-2 col-md-4 col-sm-6 col-6 wow fadeInUp" data-wow-delay="0.25s">
        <figure data-toggle="tooltip" data-placement="top" title="The smaller male cones release pollen, which fertilizes"> <img src="/asset/images/services-icon12.png" alt="Image">
